...
const NAV_ITEMS = [
  ...
  { icon: <HeartHandshake size={18} />,  label: 'Counselling',       route: '/admin/counselling' },
  ...
  return (
    <div className={`flex h-screen overflow-hidden ${overlayBg}`}>
      ...
      >
        ...
        `}>
          <div className="h-8 w-8 shrink-0 bg-fuchsia-600 rounded-lg
        ...
        <div className={`p-3 border-t ${isDark ? 'border-white/5' : 'border-slate-200'}`}>
          <button
            ...
            className="flex items-center w-full p-3 rounded-xl text-red-500
        ...
        <div className={`flex items-center justify-between px-6 py-4
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="h-6 w-6 bg-fuchsia-600 rounded flex items-center
                justify-center">
