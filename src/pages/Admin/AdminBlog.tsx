    ...
    <div className={`min-h-screen ${style.bg}`}>
      ...
      {showEditor && (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/50 px-4 py-6 sm:px-6">
          <div className="relative w-full max-w-5xl overflow-hidden rounded-none bg-white shadow-2xl sm:rounded-3xl">
                ...
                <label className="space-y-2 text-sm text-slate-700">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-2xl bg-[#a21caf] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#7c3aed]"
                    >
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    onClick={savePost}
                    disabled={isSaving}
                    className="rounded-2xl bg-[#a21caf] px-4 py-3 text-sm font-semibold uppercase tracking-[0.15em] text-white transition hover:bg-[#7c3aed] disabled:cursor-not-allowed disabled:opacity-60"
